      ...
      new CodeBlock(
        [
          ...
          new CodeLine(
            "y == 20",
            StateEnum.ERROR,
            "Using '==' instead of '=' for assignment does not work. This would only check for equality.",
          ),
          new CodeLine(
            "y = 30",
            StateEnum.CORRECT,
            "Correct syntax for variable declaration.",
            10,
          ),
          new CodeLine(
            "y 40",
      ...
      new CodeBlock(
        [
          new CodeLine(
            "a = None",
            StateEnum.NORMAL,
            "Correct use of None to initialize a variable.",
          ),
          new CodeLine(
            "a = 30; b = 10",
            StateEnum.NORMAL,
            "Using semicolon for multiple statements on one line is valid, though not Pythonic.",
          ),
          new CodeLine(
            "a, b = 30",
            StateEnum.ERROR,
            "Incorrect multiple assignment, requires a value for each variable.",
          ),
          new CodeLine(
            "a, b, = 30",
            StateEnum.WRONG,
            "We have the same problem as above. Python requires a value for each variable.",
          ),
          new CodeLine(
            "a, b = 10, 20",
            StateEnum.CORRECT,
            "Multiple assignment is correct and Pythonic.",
          ),
          new CodeLine(
            "a, b = (10, 20, 30)",
            StateEnum.WRONG,
            "Too many values to unpack; we only have 2 variables but 3 values.",
          ),
          new CodeLine(
            "a b = 10 20",
            StateEnum.WRONG,
            "Missing commas and equals sign for proper multiple assignment.",
          ),
          new CodeLine(
            "j = k = 90",
            StateEnum.NORMAL,
            "Chain assignment is valid in Python.",
          ),
        ],
        "python",
      ),
      ...
      new CodeBlock(
        [
          ...
          new CodeLine(
            "  my_list_append(i)",
            StateEnum.WRONG,
            "That is not how to append.",
          ),
          new CodeLine(
            "  my_list.append(i)",
            StateEnum.CORRECT,
            "Correctly appends i to the list after the loop.",
          ),
          new CodeLine(
            "  my_list.append[i]",
            StateEnum.WRONG,
            "Incorrect use of brackets instead of parentheses for the append method.",
          ),
          new CodeLine(
            "  my_list += i",
            StateEnum.WRONG,
